    ...
    <section className="getStarted-wrapper">
          <div className="paddings innerWidth getStarted-container">
               <div className="flexColCenter inner-container">
                    ...
                    <span>A <span className='darkRedText'>conclusão do desenvolvimento do T-Vírus</span>, componente central do Regenerate®, é o que nos separa de liberarmos ao público nosso
                         mais estimado produto.
                    </span>
                    <span>A <span className='darkRedText'  >Umbrella Corporation escolherá felizardos</span> para ter a honra de participar dessa reta final.</span>
